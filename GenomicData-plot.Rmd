...
hepg2 <- read.table("./TF_HepG2_withoutPromoter_Intersect_S1ENDSeq.txt", header = F, sep = "\t")
k562 <- read.table("./TF_K562_withoutPromoter_Intersect_S1ENDSeq.txt", header = F, sep = "\t")
...
hepg2_shared <- read.table("./TF_HepG2_withoutPromoter_Intersect_S1ENDSeq_shared.txt", header = F, sep = "\t")
k562_shared <- read.table("./TF_K562_withoutPromoter_Intersect_S1ENDSeq_shared.txt", header = F, sep = "\t")
...
library(ggplot2)
library(lubridate)
# Combined five cell lines of S1-END-seq-mapped reference set
